...
EXPORT_DECL(void, GX2ClearDepthStencilEx, GX2DepthBuffer* depthBuffer, f32 depth_value, u8 stencilValue, s32 clearMode);
EXPORT_DECL(void, GX2SetClearDepthStencil, GX2DepthBuffer* depthBuffer, f32 depth_value, u8 stencilValue);
...
EXPORT_DECL(void, GX2SetDepthStencilControl, s32 enableDepthTest, s32 enableDepthWrite, s32 depthCompFunction,  s32 stencilTestEnable, s32 backStencilEnable,
            s32 fontStencilFunc, s32 frontStencilZPass, s32 frontStencilZFail, s32 frontStencilFail,
            s32 backStencilFunc, s32 backStencilZPpass, s32 backStencilZFail, s32 backStencilFail);
...
extern "C" void InitGX2FunctionPointers(void) {
    ...
    OS_FIND_EXPORT(gx2_handle, GX2ResetGPU);
    ...
    OS_FIND_EXPORT(gx2_handle, GX2GetSwapStatus);
    ...
    OS_FIND_EXPORT(gx2_handle, GX2SetTVScale);
    ...
    OS_FIND_EXPORT(gx2_handle, GX2RDestroyBufferEx);
