...
EXPORT_DECL(void, GX2SetScissor, u32 xOrig, u32 yOrig, u32 wd, u32 ht);
...
EXPORT_DECL(void, GX2InitDepthBufferHiZEnable, GX2DepthBuffer *depthBuffer, s32 hiZEnable);
...
EXPORT_DECL(void, GX2SetPolygonControl, s32 frontFaceMode, s32 cullFront, s32 cullBack, s32 enableMode, s32 modeFont, s32 modeBack, s32 polyOffsetFront, s32 polyOffsetBack, s32 pointLineOffset);
...
void InitAcquireGX2(void) {
    ...
    OSDynLoadAcquire("gx2.rpl", &gx2Handle);
}
