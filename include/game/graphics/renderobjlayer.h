...
public:
    ...
    public:
        ...
        virtual void setMtx(const Mtx34& rMtxRT) = 0;
        virtual const Mtx34& getMtx() const = 0;
        virtual void setScale(const Vec3f& rScale) = 0;
        virtual const Vec3f& getScale() const = 0;
        virtual bool hasShapesFlag1() const = 0;
        virtual bool hasShapesFlag2() const = 0;
        virtual s32 getBoneIdx(const sead::SafeString& rName) const = 0;
        virtual const char* getBoneName(u32 idx) const = 0;
        virtual u32 getBoneCount() const = 0;
        virtual void setBoneSRT(u32 idx, const Mtx34& rMtxRT, const Vec3f& rScale) = 0;
        virtual void getBoneSRT(u32 idx, Mtx34* pMtxRT, Vec3f* pScale) = 0;
        virtual void setBoneTransform(u32 idx, const Mtx34& rTransform) = 0;
        virtual void getBoneTransform(u32 idx, Mtx34& rTransform) = 0;
        ...
        virtual s32 getMaterialIdx(const sead::SafeString& rName) const = 0;
        ...
        virtual void getName(sead::SafeString& rName) const = 0;
        virtual void setSklAnimRelatedFloat(u32 idx, f32) = 0;
        virtual f32 getSklAnimRelatedFloat() = 0;
        virtual void setSklAnim(u32 idx, const SkeletalAnimation& rAnim) = 0;
        virtual void setTexAnim(u32 idx, const TextureAnimation& rAnim) = 0;
        virtual void setShuAnim(u32 idx, const ShaderAnimation& rAnim) = 0;
        virtual void setVisAnim(u32 idx, const VisibilityAnimation& rAnim) = 0;
        virtual void setShaAnim(u32 idx, const ShapeAnimation& rAnim) = 0;
        virtual const SkeletalAnimation** getSklAnims() const = 0;
        virtual const TextureAnimation** getTexAnims() const = 0;
        virtual const ShaderAnimation** getShuAnims() const = 0;
