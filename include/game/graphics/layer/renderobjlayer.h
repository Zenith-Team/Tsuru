...
public:
    ...
    public:
        ...
        virtual void setScale(const sead::Vec3f& scale) = 0;
        virtual const sead::Vec3f& getScale() const = 0;
        ...
        virtual void setBoneSRT(u32 idx, const Mtx34& mtxRT, const sead::Vec3f& scale) = 0;
        virtual void getBoneSRT(u32 idx, Mtx34* mtxRT, sead::Vec3f* scale) = 0;
