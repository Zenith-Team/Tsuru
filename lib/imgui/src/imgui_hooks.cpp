...
extern "C" sead::Heap* createImGuiHeap(u32, u32, sead::Heap* parent) {
    ...
    sImGuiHeap = sead::ExpHeap::tryCreate(size, "ImGuiHeap", parent, sead::Heap::cHeapDirection_Forward, false);
...
void endImGui() {
    ...
    agl::RenderBuffer* renderBuffer = agl::lyr::Renderer::instance()->getRenderBuffer(0);
